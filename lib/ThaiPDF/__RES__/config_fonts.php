...
/* Thai fonts */
	...
	"kinnari" => array(
		'R' => "Kinnari.ttf",
		'B' => "Kinnari-Bold.ttf",
		'I' => "Kinnari-Oblique.ttf",
		'BI' => "Kinnari-BoldOblique.ttf"
		),	
	"loma" => array(
		'R' => "Loma.ttf",
		'B' => "Loma-Bold.ttf",
		'I' => "Loma-Oblique.ttf",
		'BI' => "Loma-BoldOblique.ttf"
		),
	"purisa" => array(
		'R' => "Purisa.ttf",
		'B' => "Purisa-Bold.ttf",
		'I' => "Purisa-Oblique.ttf",
		'BI' => "Purisa-BoldOblique.ttf"
		),
	"sawasdee" => array(
		'R' => "Sawasdee.ttf",
		'B' => "Sawasdee-Bold.ttf",
		'I' => "Sawasdee-Oblique.ttf",
		'BI' => "Sawasdee-BoldOblique.ttf"
		),
	"tlwg-typewriter" => array(
		'R' => "TlwgTypewriter.ttf",
		'B' => "TlwgTypewriter-Bold.ttf",
		'I' => "TlwgTypewriter-Oblique.ttf",
		'BI' => "TlwgTypewriter-BoldOblique.ttf"
		),
	"tlwg-typist" => array(
		'R' => "TlwgTypist.ttf",
		'B' => "TlwgTypist-Bold.ttf",
		'I' => "TlwgTypist-Oblique.ttf",
		'BI' => "TlwgTypist-BoldOblique.ttf"
		),
	"tlwg-typo" => array(
		'R' => "TlwgTypo.ttf",
		'B' => "TlwgTypo-Bold.ttf",
		'I' => "TlwgTypo-Oblique.ttf",
		'BI' => "TlwgTypo-BoldOblique.ttf"
		),	
	"umpush" => array(
		'R' => "Umpush.ttf",
		'B' => "Umpush-Bold.ttf",
		'I' => "Umpush-Oblique.ttf",
		'BI' => "Umpush-BoldOblique.ttf"
		),		
	"waree" => array(
		'R' => "Waree.ttf",
		'B' => "Waree-Bold.ttf",
		'I' => "Waree-Oblique.ttf",
		'BI' => "Waree-BoldOblique.ttf"
		),		
