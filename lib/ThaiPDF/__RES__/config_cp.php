...
function GetLangOpts($llcc, $adobeCJK) {
	...
	//	else { $unifonts = ""; }
	  ...
	  // THAI
	  CASE "th":  $unifonts = "garuda,garudaB,garudaI,garudaBI,norasi,norasiB,norasiI,norasiBI,loma,lomaB,lomaI,lomaBI,purisa,purisaB,purisaI,purisaBI,sawasdee,sawasdeeB,sawasdeeI,sawasdeeBI,waree,wareeB,wareeI,sawasdeeBI,kinnari,kinnariB,kinnariI,kinnariBI,umpush,umpushB,umpushI,umpushBI,tlwg-typewriter,tlwg-typewriterB,tlwg-typewriterI,tlwg-typewriterBI,tlwg-typist,tlwg-typistB,tlwg-typistI,tlwg-typistBI,twlg-typo,twlg-typoB,twlg-typoI,twlg-typoBI";  break;
